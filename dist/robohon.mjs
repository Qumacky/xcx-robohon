...
var en$1 = {
	"robohon.entry.name": "RoBoHoN",
	"robohon.entry.description": "Description of this extension"
};
var ja$1 = {
	"robohon.entry.name": "RoBoHoN",
	"robohon.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"robohon.entry.name": "RoBoHoN",
	"robohon.entry.description": "かくちょうきのうのせつめい"
}
};
...
var entry = {
  ...
  extensionId: 'robohon',
  extensionURL: 'https://Qumacky.github.io/xcx-robohon/dist/robohon.mjs',
  ...
  helpLink: 'https://Qumacky.github.io/xcx-robohon/',
...
var en = {
	"robohon.name": "RoBoHoN",
	"robohon.doIt": "do it [SCRIPT]"
};
var ja = {
	"robohon.name": "RoBoHoN",
	"robohon.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
...
var extensionURL = 'https://Qumacky.github.io/xcx-robohon/dist/robohon.mjs';
/**
...
var ExtensionBlocks = /*#__PURE__*/function () {
  /**
   * Construct a set of blocks for RoBoHoN.
   * @param {Runtime} runtime - the Scratch 3.0 runtime.
   */
  function ExtensionBlocks(runtime) {
    classCallCheck(this, ExtensionBlocks);
