...
var en$1 = {
	"myBlock.entry.name": "RoBoHoN",
	"myBlock.entry.description": "Description of this extension"
};
var ja$1 = {
	"myBlock.entry.name": "RoBoHoN",
	"myBlock.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"myBlock.entry.name": "RoBoHoN",
	"myBlock.entry.description": "かくちょうきのうのせつめい"
}
};
...
var entry = {
  ...
  extensionId: 'myBlock',
  extensionURL: 'https://Qumacky.github.io/xcx-robohon/dist/myBlock.mjs',
...
var en = {
	"myBlock.name": "RoBoHoN",
	"myBlock.doIt": "do it [SCRIPT]"
};
var ja = {
	"myBlock.name": "RoBoHoN",
	"myBlock.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
